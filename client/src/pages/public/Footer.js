  ...
  <div className="w-full px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <div className="flex "><i class="fa-solid fa-house mr-5 h-6 sm:h-9"></i> <p>Trọ tốt</p>
        
        </div>
        <p className="max-w-xs mt-4 text-sm text-gray-600">
          Ở được nơi tôt sẽ giúp bạn đỡ áp lực khi đi học và làm việc nha
        </p>
      ...
      <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            <a className="hover:opacity-75" href> Đà lạt </a>
            <a className="hover:opacity-75" href> Nhóm 5 </a>
            <a className="hover:opacity-75" href> Tháng 09/2023</a>
        ...
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            ...
            <a className="hover:opacity-75" href> Thông tin công ty </a>
            <a className="hover:opacity-75" href> Thông tin Chủ </a>
            <a className="hover:opacity-75" href> Bộ Phận HR</a>
        ...
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            <a className="hover:opacity-75" href> 0797878315 </a>
            <a className="hover:opacity-75" href> Phu3365@gmail.com </a>
            <a className="hover:opacity-75" href> 80/Mai Anh Đào/P8/TP.Đà Lạt </a>
          </nav>
        </div>
        <div>
          <p className="font-medium">
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            ...
            <a className="hover:opacity-75" href> Điều Khoản &amp; Điều Kiện </a>
            <a className="hover:opacity-75" href> Chính Sách Hoàn Trả </a>
